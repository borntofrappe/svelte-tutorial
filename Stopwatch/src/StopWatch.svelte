<script>
    ...
    $: ms = lastDigit(Math.floor(lapse / 100));
</script>
...
<svg viewBox="0 0 100 100" width="300" height="300">
    <g transform="translate(50 50)">
        ...
        <!-- hard-coded value -->
        <text text-anchor="middle" fill="currentColor" dominant-baseline="middle" font-size="10" style="font-weight: 300; letter-spacing: 1px;">{mm}:{ss}.{ms}</text>
    </g>
</svg>
