		...
		<g transform="translate(100 100)">
			<g transform="translate(100 0)">
				<g fill="currentColor" dominant-baseline="middle">
					<text style="text-transform: uppercase;" y="-35" font-weight="bold" font-size="16">{key}</text>
					<text><tspan font-weight="bold" font-size="38">+{value}</tspan> <tspan font-size="14" font-weight="initial">(s/lap)</tspan></text>
				</g>
			</g>
