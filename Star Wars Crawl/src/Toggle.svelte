<script>
	...
	$: if(checked) hue = randomItem(sabers);
</script>
<style>
label {
    position: relative;
...
<label>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -3 98 6">
        <g transform="translate(12.25 0)" stroke-linecap="round" fill="none" stroke="hsl({hue}, 100%, 65%)" stroke-width="3.5">
            <path id="saber" d="M 0 0 h 48" stroke-dasharray="49" stroke-dashoffset="{checked ? 0 : 49}" />
        </g>
        ...
        <g transform="translate(65 0)">
            <g id="text" transform="translate({checked ? 0 : -45} 0)">
