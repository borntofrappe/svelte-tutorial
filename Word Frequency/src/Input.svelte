<script>
  ...
  function defaultText() {
    return 'Either you clicked on "Count Words" without words to count, or the "Load sample" button failed to... well, load a sample. Of words. So here we are. Words, a button, two buttons, and very little to show for it. Well, now you have some words to can actually count. Plus a blue button just waiting for you. Button, button. You\'ve got the button.';
  }
...
<main class="input">
  ...
  <textarea bind:value />
  <div class="controls">
    <button on:click={count}> Count words </button>
