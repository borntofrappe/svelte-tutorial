export const demos = [
  ...
  },
  {
    ...
    "html": "<p>The project is meant to provide a helpful environment to write notes and most prominently <code>README.md</code> files.</p><p>The demo leans on <a href='https://marked.js.org/'><code>marked.js</code></a> for the conversion between markdown and markup.",
  ...
  },
  {
    ...
    "html": "<p>The project is based on a previous experiment with the table element, in which I used JavaScript to plot a series of levels through columns, rows and cells of SVG elements. You can find the experiment <a href='https://codepen.io/borntofrappe/full/MWgEbPz'>live here on codepen</a>.</p>",
  ...
  },
  {
    ...
    "html": "<p>The project is inspired by a gadget proposed in the pokemon game series, a smart watch with a plethora of applications. I set out to recreate a few of them to highlight the potential of a component-based approach.</p>",
  ...
  },
  {
    ...
    "html": "<p>The project sets up a basic <abbr title='Create Read Update Delete'>CRUD</abbr> application, for a hypothetical shopping list.</p><p>It is possible to modify the data, but also illustrate the items with a couple of basics visualization using <a href='https://d3js.org/'><code>d3.js</code></a>.</p>",
