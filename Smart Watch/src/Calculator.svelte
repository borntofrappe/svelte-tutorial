...
<svg viewBox="0 0 450 80" width="450" height="80">
  <defs>
    <!-- numbers -->
    <path id="0" d="M 10 5 h 20 v 30 h -20 z" />
    <path id="1" d="M 20 5 h 5 v 30 m -5 0 h 10" />
    <path id="2" d="M 10 5 h 20 v 15 h -20 v 15 h 20" />
    <path id="3" d="M 10 5 h 20 v 30 h -20 m 0 -15 h 20" />
    <path id="4" d="M 10 5 v 15 h 20 m -5 -15 v 30" />
    <path id="5" d="M 30 5 h -20 v 15 h 20 v 15 h -20" />
    <path id="6" d="M 30 5 h -20 v 30 h 20 v -15 h -20" />
    <path id="7" d="M 10 5 h 20 v 30" />
    <path id="8" d="M 10 5 h 20 v 30 h -20 z m 0 15 h 20" />
    <path id="9" d="M 30 35 v -30 h -20 v 15 h 20" />
    <!-- operations -->
    <path id="+" d="M 5 20 h 30 m -15 -15 v 30" />
    <path id="-" d="M 5 20 h 30" />
    <path id="*" d="M 7 7 l 26 26 m 0 -26 l -26 26" />
    <path id="/" d="M 5 20 h 30 m -15 -15 v 0 m 0 30 v 0" />
    <path id="=" d="M 5 12 h 30 m -30 16 h 30" />
    <path id="." d="M 10 35 h 0" />
    <path id="clear" d="M 32 12 v -7 h -24 v 30 h 24 v -7" />
    ...
    <path id="?" d="M 8 15 v -10 h 24 v 15 h -12 v 5 m 0 10 v 0" />
    <!-- graphic shown if the input number is less than 9 digits long -->
    <use id="placeholder" opacity="0.35" href="#8" />
  </defs>

  <g fill="none" stroke="currentColor" stroke-width="16">
    <rect x="8" y="-5" width="434" height="90" />
  </g>
